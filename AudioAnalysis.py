...
";border: 1px solid white;border-radius: 10px;")
    ...
    def recordFirstAudio(self):
        ...
        sd.wait()
        write('output1.wav', fs, myrecording) #You can customize this by changing the name of the file to be written
        print('Recoding Done')
        time.sleep(5)
    ...
    def recordSecondAudio(self):
        ...
        myrecording = sd.rec(int(seconds * fs), samplerate=fs, channels=2)
        sd.wait()
        write('output2.wav', fs, myrecording) from __future__ import print_function
import librosa
import time
import sys
from PIL import Image, ImageTk, ImageChops
...
#         self.labelResultImage.setObjectName("labelResultImage")
    ...
    def recordFirstAudio(self):
        ...
        myrecording = sd.rec(int(seconds * fs), samplerate=fs, channels=2)
        sd.wait()
        write('output1.wav', fs, myrecording) from __future__ import print_function
import librosa
import time
import sys
from PIL import Image, ImageTk, ImageChops
